...
class Cue(pygame.sprite.Sprite):
    ...
    def clear_canvas(self):
        # создать пустую поверхность в качестве заполнителя для cue
    ...
    def is_point_in_cue(self, point):
        # этот алгоритм разбивает прямоугольник на 4 треугольника, используя заданную точку
        # если указанная точка находится внутри треугольника, сумма площадей треугольников
        # должна быть равна площади прямоугольника
        ...
        # +1 для предотвращения ошибок округления
